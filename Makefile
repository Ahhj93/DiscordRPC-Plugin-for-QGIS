...
SOURCES = \
	__init__.py \
	discord_rpc.py discord_rpc_dialog.py

PLUGINNAME = discord_rpc

PY_FILES = \
	__init__.py \
	discord_rpc.py discord_rpc_dialog.py

UI_FILES = discord_rpc_dialog_base.ui
...
QGISDIR=C:\Users\ryse9\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
